...
Revision ID: 4afafa577807
Revises: 
Create Date: 2022-11-07 10:09:15.305435
...
def upgrade():
    ...
    sa.Column('num_of_donors', sa.Integer(), nullable=True),
    ...
    sa.Column('date_updated', sa.String(length=128), nullable=True),
